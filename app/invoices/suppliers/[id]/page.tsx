...
export default async function SupplierInvoicePage({ params }: SupplierInvoicePageProps) {
  ...
  return (
    <div className="invoice-page min-h-screen bg-white dark:bg-slate-950 px-2 py-2 md:px-4">
      ...
      <section className="invoice-sheet mx-auto max-w-4xl overflow-hidden bg-white shadow-sm">
        ...
        <div className="px-6 py-6 grid grid-cols-2 gap-8 border-b border-gray-200">
          <div>
            ...
            <div className="space-y-1 text-sm text-gray-700">
              <p className="font-semibold">{formatDisplayName(invoice.name, "Supplier")}</p>
              <p>📍 {invoice.address}</p>
              <p>☎️ {invoice.phone}</p>
            </div>
          </div>
        ...
        <div className="px-6 py-6">
          <div className="overflow-x-auto rounded border border-gray-200">
            <table className="min-w-full text-left text-sm">
              ...
              <tbody>
                <SupplierInvoiceTable records={invoice.records} />
              </tbody>
            </table>
          </div>
        </div>
        ...
        <div className="px-6 py-6 border-b border-gray-200">
          <div className="grid grid-cols-2 gap-8">
            ...
            <div>
              <p className="text-xs font-bold text-gray-700 mb-3">PURCHASE INFORMATION</p>
              <div className="space-y-2 text-sm text-gray-700">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold">{formatQuantity(invoice.totalSaltMaund)} maund</span>
                </div>
                <div className="flex justify-between">
        ...
        <div className="px-6 py-6 border-b border-gray-200">
          ...
          <div className="grid grid-cols-2 gap-8 text-center">
            <div>
              <div className="border-t border-gray-300 pt-2 text-xs text-gray-700">Supplier Signature</div>
            </div>
            <div>
